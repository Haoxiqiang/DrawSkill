...
jboolean Java_org_opentalking_drawskill_SurfaceDiff_findBounds(JNIEnv *env, jobject obj, jintArray original, jobject updatedSurf, jobject diffResult) {
    ...
    jclass cls = (*env)->FindClass(env, "org/opentalking/drawskill/SurfaceDiff$DiffResult");
